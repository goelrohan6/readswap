...
<?php  
$query2="SELECT * FROM isseud_novel WHERE username_from='$user' and exceeded =1 ";
                    ...
                    <div class="ratings">
                      <center>
                       <p style="margin-bottom:1px;" class="ng-binding">
                        ...
                        <a onclick="alert('Confirm?')" type="button" href="confirm.php?issued_novel=<?php echo $novel_name ; ?>" class="btn btn-success btn-xs" >Confirm</a>   
