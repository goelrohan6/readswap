...
{ // DONT FORGET TO CLOSE THIS BRACE AT THE END OF </HTML> TAG .....
  ...
  if (isset($_GET['search'])) {
    $query2="SELECT * FROM novel_info WHERE username != '$user' AND is_issued=0 AND name Like '".$_GET['search']."' ";
  }else {
    $query2="SELECT * FROM novel_info WHERE username != '$user' AND is_issued=0 ";
  }
  ...
  <head>
    ...
    <!--<script src="../get_hint.js" type="text/javascript" charset="utf-8" async defer></script>-->
    <script>
    ...
    <div class="container" style="margin-top:60px;">
      <ul id="gn-menu" class="gn-menu-main">
        <li class="gn-trigger">
              ...
              <ul class="gn-menu">
                ...
                <li><a   href="novel_upload.php"  class="gn-icon  menu_items gn-icon-societies">Upload Novels</a>
                  <li><a   href="delete_novel.php" class="gn-icon  menu_items gn-icon-calendar">Delete Novels</a>
                    ...
                    <li><a   href="wishlist.php" class="gn-icon  menu_items gn-icon-blog">Wishlist</a></li>
          ...
          <a style="color:white; font-size:2em; cursor:pointer;" title="Make a wish" ng-hide="authenticated" data-toggle="modal" data-target="#myModal" class="">
      ...
      <div class="row">
        ...
        <form action="" class="form-inline " method="GET">
          <div class="forms-group">
            <input type="search" onkeyup="showHint(this.value)" placeholder="Search" id="search" class="form-control" name="search"ng-model="search">
          </div>
        </form>
            ...
            <div class="modal-dialog modal-sm">
              ...
              <div class="modal-content">
                ...
                <div class="modal-header" style="background-color:#339933;">
                  ...
                  <form class="form-horizontal"  method="GET" action="wish.php">
                ...
                <div class="modal-footer">
                  <input onclick="alert('Confirm?')" type="submit" class="btn btn-default btn-success" value="wish" >
              </div>
                </form>
